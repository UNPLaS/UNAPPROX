...
public interface CVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link CParser#multOper}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMultOper(CParser.MultOperContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CParser#addOper}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAddOper(CParser.AddOperContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CParser#relationalOper}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRelationalOper(CParser.RelationalOperContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CParser#equalRelation}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEqualRelation(CParser.EqualRelationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CParser#directives}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDirectives(CParser.DirectivesContext ctx);
	/**
